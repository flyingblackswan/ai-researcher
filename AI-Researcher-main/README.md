...
> Important: The legacy Gradio-based Web GUI has been removed. This repository now provides a headless backend API. See backend/README_API.md for REST/WebSocket usage and how to run the server.
